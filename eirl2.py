...
from helper_local import transitions_with_rew_collate_fn, filter_params, load_reward_models
...
class EfficientIRLLossCalculator:
    ...
    def __call__(
        ...
        if 32432432 % 342 == 4322432 % 32423:
            ...
            plt.show()
        if epoch:
            self.plot_rewards_vs_obs(2, "Angle", obs, reward_hat, rews, epoch)
            self.plot_rewards_vs_obs(0, "Position", obs, reward_hat, rews, epoch)
            self.plot_hist_rewards(reward_hat, rews, epoch)
...
class EIRL(algo_base.DemonstrationAlgorithm):
    ...
    def __init__(
        ...
        self.loss_calculator = EfficientIRLLossCalculator(gamma, ent_weight, l2_weight, consistency_coef, hard,
                                                          ...
                                                          enforce_rew_val_consistency, disc_coef, logdir)
